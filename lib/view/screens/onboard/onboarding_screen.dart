        ...
        onBoardingController.onBoardingList.length > 0 ? SafeArea(
          child: Center(child: SizedBox(width: Dimensions.WEB_MAX_WIDTH, child: Column(children: [
              ...
              itemBuilder: (context, index) {
                return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(onBoardingController.onBoardingList[index].imageUrl, height: context.height*0.3),
                  ),

                  Text(
                    onBoardingController.onBoardingList[index].title,
                    style: robotoBold.copyWith(fontSize: Dimensions.fontSizeOverLarge/*context.height*0.022*/),
            ...
            Padding(
              ...
              child: Row(children: [
                onBoardingController.selectedIndex == 4 ? SizedBox() :
                /*Expanded(
                  child: CustomButton(
                    transparent: true,
                    onPressed: () {
                ...
                Expanded(
                  child: CustomButton(
                    buttonText: onBoardingController.selectedIndex != 3 ? 'next'.tr : 'get_started'.tr,
                    onPressed: () {
