...
class _AddNewMembersState extends State<AddNewMembers> {
                ...
                builder: (carlistingController) {
                  return */
                                  TypeAheadField(
                                    ...
                                    itemBuilder: (context,
                                        RegionResponseModel suggestion) {
                                      return Padding(
                                    ...
                                    onSuggestionSelected:
                                        (RegionResponseModel suggestion) async {
                                      _regionController.text = language == "ar"
                                          ? suggestion.provinces_ar
                                          : suggestion.provinces;
                                      _regionIdController.text =
  ...
  void _login(AuthController authController) async {
    ...
    if (_name.isEmpty) {
      ...
      showCustomSnackBar('Enter Function '.tr);
    } else if (dob.isEmpty) {
      showCustomSnackBar('Select DOB '.tr);
    } else if (sex.isEmpty) {
      showCustomSnackBar('Select sex '.tr);
    } else {
