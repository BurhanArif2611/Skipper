...
class PendingOrderView extends StatelessWidget {
  ...
  PendingOrderView({@required this.isRunning});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: GetBuilder<WalletController>(builder: (orderController) {
        ...
        return orderController != null && orderController.pendingTransactionList!=null ? orderController.pendingTransactionList.length > 0 ?
        RefreshIndicator(
          onRefresh: () async {
            if(isRunning) {
              await orderController.getWalletTransactionList('1',"accepted", false, true);
            }else {
              await orderController.getWalletPendingTransactionList('1',"pending", false, true);
            }
          },
                ...
                child: PaginatedListView(
                  ...
                  onPaginate: (int offset) {
                    if(isRunning) {
                      ...
                      Get.find<WalletController>().getWalletPendingTransactionList('1',"pending", false, true);
                    }
                  },

                  itemView: orderController.pendingTransactionList != null
                      ? orderController
