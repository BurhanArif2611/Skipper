...
class TeamCardWithCount extends StatelessWidget {
  Matches matches;
  bool shadow;
  ...
  Widget build(BuildContext context) {
    ...
    return
                    Row(
                      children: [
                        Text(homeController.matchTeamList!=null && homeController.matchTeamList.data!=null ?
                          "${homeController.matchTeamList.data.length} Team":"0 Team",
                          style: robotoRegular.copyWith(
                              color: Theme.of(context).cardColor,
                              fontSize: Dimensions.fontSizeExtraSmall),
                        ),
                        ...
                        Text(homeController.leagueList!=null && homeController.leagueList.data!=null ?
                          "${homeController.leagueList.data.length} Contests":"0 Contests",
                          style: robotoRegular.copyWith(
                              color: Theme.of(context).cardColor,
                              fontSize: Dimensions.fontSizeExtraSmall),
                        )
