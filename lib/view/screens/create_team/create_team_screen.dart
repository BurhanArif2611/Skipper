                            ...
                            child: Container(
                                ...
                                child: Column(
                                  children: [
                                          ...
                                          Expanded(
                                              ...
                                              child: Text(
                                                authController
                                                            .selectedTeamMemberIndex ==
                                                        0
                                                    ? "Select between 1-2 wicket keepers"
                                                    : authController
                                                                .selectedTeamMemberIndex ==
                                                            1
                                                        ? "Select between 3-5 batsmen"
                                                        : authController
                                                                    .selectedTeamMemberIndex ==
                                                                2
                                                            ? "Select between 1-3 All-rounders "
                                                            : "Select between 3-5 bowlers",
                                                style: robotoBold.copyWith(
                                    ...
                                    Expanded(
                                        // Use Expanded if this is inside a Column or Row
                                        ...
                                        if (Get.find<HomeController>()
                                          ...
                                          if (Get.find<HomeController>()
                                            ...
                                            if (Get.find<HomeController>()
                                              ...
                                              showCustomSnackBar(
                                                  "Please select at least 3 Bowlers.",
                                                  isError: true);
                                            }
                                          } else {
                                            showCustomSnackBar(
                                                "Please select at least 3 batsmen.",
                                                isError: true);
                                          }
                                        } else {
                                          showCustomSnackBar(
                                              "Please select at least one wicketkeeper.",
                                              isError: true);
                                        }
                                      } else {
                                        showCustomSnackBar(
    ...
    return GetBuilder<HomeController>(builder: (homeController) {
      return homeController.keepMenPlayersList != null &&
          ...
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return MemberCard(
                    homeController.keepMenPlayersList[index], "keeper");
              })
    ...
    return GetBuilder<HomeController>(builder: (homeController) {
      return homeController.bowlMenPlayersList != null &&
          ...
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return MemberCard(
                    homeController.bowlMenPlayersList[index], "bowler");
              })
    ...
    return GetBuilder<HomeController>(builder: (homeController) {
      return homeController.allRoundMenPlayersList != null &&
          ...
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return MemberCard(
                    homeController.allRoundMenPlayersList[index], "allRounder");
              })
    ...
    return GetBuilder<HomeController>(builder: (homeController) {
      return homeController.batsMenPlayersList != null &&
          ...
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return MemberCard(
                    homeController.batsMenPlayersList[index], "bats");
              })
