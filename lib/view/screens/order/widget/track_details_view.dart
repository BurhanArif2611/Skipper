  ...
  Widget build(BuildContext context) {
    ...
    try {
      if (track.deliveryMan != null) {
        if (track.deliveryMan != null && track.deliveryMan.lat!=null && track.deliveryMan.lng !=null) {
          _distance = double.parse((Geolocator.distanceBetween(
                    ...
                    Expanded(
                        ...
                        child: Text(
                          _takeAway
                              ? track != null &&
                                      track.deliveryAddress != null &&
                                      track.deliveryAddress.address != null
