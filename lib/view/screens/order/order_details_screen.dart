...
class OrderDetailsScreen extends StatefulWidget {
  ...
  OrderDetailsScreen({@required this.orderModel, @required this.orderId, @required this.isRunning});
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    print("loan lsit outer>>" + state.name.toString());
    if (state == AppLifecycleState.resumed) {
      print("loan lsit inner>>" + state.name.toString());
      print("loan lsit inner>>" + widget.orderId.toString());
                            ...
                            child: Column(
                                ...
                                children: [
                                  Row(children: [
                                    ...
                                    Text(_order!=null?_order.id.toString():'',
                                        style: robotoMedium),
                                    SizedBox(
                                        width: Dimensions
                                            .PADDING_SIZE_EXTRA_SMALL),
                                        ...
                                        ? Row(children: [
                                            ...
                                            (_order != null &&
                                                ...
                                                ? Text(
                                                    _order.orderStatus ==
                                                            'delivered'
                                                        ? '${'delivered_at'.tr} ${DateConverter.dateTimeStringToDateTime(_order != null && _order.delivered != "" ? _order.delivered : 0)}'
                                      ...
                                      ? Row(children: [
                                          ...
                                          SizedBox(
                                              width: Dimensions
                                                  .PADDING_SIZE_EXTRA_SMALL),
                                          Text(
                                            _order.delivery_type != null
                                                ? _order.delivery_type
                                                    .toString()
                                                : "".toString(),
                                            style: robotoMedium.copyWith(
                                                color: Theme.of(context)
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Wrap(children: [
                                                              (_order.dropoff_locations[index].receiver_details.streetNumber !=
                                                                          null &&
                                                                      _order
                                                                          .dropoff_locations[
                                                                              index]
                                                                  ...
                                                                  : SizedBox(),
                                                              (_order.dropoff_locations[index].receiver_details.house !=
                                                                          null &&
                                                                      _order
                                                                          .dropoff_locations[
                                                                              index]
                                                                  ...
                                                                  : SizedBox(),
                                                              (_order.dropoff_locations[index].receiver_details.floor !=
                                                                          null &&
                                                                      _order
                                                                          .dropoff_locations[
                                                                              index]
                                  ...
                                  if (_order.orderType == 'errand' &&
                                      _errand &&
                                      _order.errand_bids != null &&
                                      _order.errand_bids.length > 0)
                                  ...
                                  if (_order.orderType == 'errand' &&
                                    ...
                                    ListView.builder(
                                      ...
                                      padding: EdgeInsets.zero,
                                      itemBuilder: (context, index) {
                                        double amount = double.parse(_order
                                            .errand_bids[index].counter_amount);
                                                    ...
                                                    Row(children: [
                                                      ClipOval(
                                                        ...
                                                        image: _order
                                                                ...
                                                                _order
                                                                        ...
                                                                        .identity_image !=
                                                                    null
                                                            ? '${Get.find<SplashController>().configModel.baseUrls.parcelCategoryImageUrl}/${_order.errand_bids[index].delivery_man.identity_image}'
                                                            : Images.about_us,
                                                        height: 35,
                                                        width: 35,
                                                        fit: BoxFit.cover,
                                                      ...
                                                      Expanded(
                                                          child: Column(
                                                            ...
                                                            Text(
                                                                DateConverter.dateToDateAndTime(DateConverter.isoStringToLocalDate(_order.errand_bids[index].delivery_man.updated_at)),
                                                              maxLines: 1,
                                                              overflow:
                                                                  TextOverflow
                                                                      .ellipsis,
                                                          ...
                                                          Align(
                                                              ...
                                                              child:
                                                                  DottedBorder(
                                                                      ...
                                                                      strokeWidth:
                                                                          1,
                                                                      child: (_order.errand_tasks[position].errand_task_media.length >
                                                                              0
                                                                          ? CustomImage(
                                  ...
                                  if (_errand && _order.orderType == 'errand'&&
                                      _order.errand_bids != null &&
                                      _order.errand_bids.length == 0)
                                  ...
                                  if (_errand && _order.orderType == 'errand'&&
                                      _order.errand_bids != null &&
                                      _order.errand_bids.length == 0 &&  _order.orderStatus !=AppConstants.Canceled)
                                    Container(
                                      ...
                                      child: Text(
                                        'Waiting for the Vendor to Accept the Order.'.tr,
                                        style: robotoMedium,
                                      ),
                                    ),
                                  ResponsiveHelper.isDesktop(context)
  ...
  Widget _bottomView(
    ...
    return Column(children: [
      ...
      (order.orderStatus == 'delivered' && order.deliveryMan != null
          ...
          ? Center(
              child: (orderController.orderDetailsModel != null &&
                          (orderController.orderDetailsModel.order_type ==
                                  'errand' ||
                              orderController.orderDetailsModel.order_type ==
                                  'parcel')) ||
                      orderController.orderDetailsModel != null &&
                          orderController
                                  .orderDetailsModel.is_dm_reviewed_count ==
                              0
                  ? Container(
                      width: Dimensions.WEB_MAX_WIDTH,
                      padding: ResponsiveHelper.isDesktop(context)
                        ...
                        onPressed: () {
                          ...
                          orderController.orderDetails.forEach((orderDetail) {
                            if (!_orderDetailsIdList
                              ...
                              _orderDetailsIdList
                                  .add(orderDetail.itemDetails.id);
                            }
                          });
  ...
  void orderCallback(bool isSuccess, String message, String orderID) {
    ...
    if (isSuccess) {
      ...
      else if (Get.find<OrderController>().paymentIndex == 1) {
        if (GetPlatform.isWeb) {
          Get.back();
          String hostname = html.window.location.hostname;
          String protocol = html.window.location.protocol;
          String selectedUrl =
              '${AppConstants.BASE_URL}/payment-mobile?transaction_type=place_order&order_id=$orderID&customer_id=${Get.find<UserController>().userInfoModel.id}&&callback=$protocol//$hostname${RouteHelper.orderSuccess}?id=$orderID&type=errand&status=';
          html.window.open(selectedUrl, "_self");
        } else {
          if (Get.find<OrderController>().paymentIndex == 1) {
            print("user_id>>>>" +
                Get.find<UserController>().userInfoModel.id.toString());
            Get.offNamed(RouteHelper.getPaymentRoute(orderID,
                Get.find<UserController>().userInfoModel.id, 'errand'));
          }
        }
      }
      else {
