...
class HomeController extends GetxController implements GetxService {
  ...
  Future<void> getSurveysDetail(String id) async {
    ...
    Response response = await authRepo.getSurveyDetail(/*id*/"64afb5cbdc66ae6bcda502a3");
    if (response.statusCode == 200) {
  ...
  Future<Response> addSOSContact(String name, String relation,String phone) async {
   ...
   // Get.dialog(CustomLoader(), barrierDismissible: false);
    Response response = await authRepo.addSOSContact(name:name,relation:relation,phone:phone );
