...
class OrderDetailsModel {
  ...
  OrderDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    discountOnItem = json['discount_on_item']!=null ?json['discount_on_item'].toDouble():0;
    discountType = json['discount_type']!=null ?json['discount_type']:"";
    quantity = json['quantity'];
    taxAmount = json['tax_amount']!=null?json['tax_amount']==0?json['tax_amount']:json['tax_amount'].toDouble():0.0;
    variant = json['variant']!=null ?json['variant']:"";
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    itemCampaignId = json['item_campaign_id']!=null ?json['item_campaign_id']:0;
