...
class ComplaintRepo {
  ...
  Future<Response> deleteComplaint({String id}) async {
    return await apiClient.deleteData('${AppConstants.ComplaintDelete_URL}/'+id );
  }
  ...
  Future<Response> getComplaintList() async {
    return await apiClient.getData(AppConstants.Complaint_URL);
  }
  Future<Response> addComplain(String complaint,String category_id, String image) async {
    return await apiClient.postData(AppConstants.Complaint_URL, {"complaint": complaint, "category_id": category_id, "image": image});
  }
}